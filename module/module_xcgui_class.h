...
//@别名  取内填充大小()
	void GetPadding(paddingSize_* pPadding){XWnd_GetPadding(m_hWindow, pPadding);}
//@备注 设置窗口拖动边框大小.  
//@参数 left 窗口左边大小.
//@参数 top 窗口上边大小.
//@参数 right 窗口右边大小.
...
//@别名  清空动画()
	void ClearAnimation(){XBtn_ClearAnimation(m_hEle);}
};
...
//@返回 成功返回TRUE否则返回FALSE.
//@别名  置项模板从内存()
	BOOL SetItemTemplateXMLFromMem(void* data, int length){return XListBox_SetItemTemplateXMLFromMem(m_hEle, data, length);}
...
//@返回 如果成功返回TRUE, 否则返回FALSE.
//@别名  创建数据适配器2()
	BOOL CreateAdapters(int col_extend_count=3){return XList_CreateAdapters(m_hEle, col_extend_count);}
//@备注 获取数据适配器.  
//@返回 数据适配器句柄.
//@别名  取数据适配器()
...
//@返回 返回文本内容.
//@别名  取文本()
	const wchar_t* GetText(){return XShapeGroupBox_GetText(m_hShape);}
//@备注 获取文本偏移量.  
//@参数 pOffsetX X坐标偏移量.
//@参数 pOffsetY Y坐标偏移量.
//@返回 成功返回TRUE否则返回FALSE.
...
//@备注 清空表格
//@别名  清空()
	void Clear(){XTable_Clear(m_hShape);}
//@参数 iRow 行索引
//@参数 iCol 列索引
//@参数 count 数量
//@别名  组合行()
...
//@参数 hFont 字体
//@别名  置项文本扩展()
	void SetItemTextEx(int iRow, int iCol, const wchar_t* pText, COLORREF textColor, COLORREF bkColor, BOOL bTextColor=TRUE, BOOL bBkColor=TRUE, HFONTX hFont=NULL){XTable_SetItemTextEx(m_hShape, iRow, iCol, pText, textColor, bkColor, bTextColor, bBkColor, hFont);}
//@参数 iRow 行索引
//@参数 iCol 列索引
//@参数 hFont 字体句柄
//@别名  置项字体()
...
//@返回 返回字符串指针
//@别名  取项文本()
	const wchar_t* GetItemText(int iRow, int iCol){return XTable_GetItemText(m_hShape, iRow, iCol);}
//@参数 iRow 行索引
//@参数 iCol 列索引
//@参数 pRect 接收返回坐标
//@返回 成功返回TRUE,否则返回FALSE
...
//@返回 返回 ID2D1Bitmap*
//@别名  取D2DBitmap()
	vint GetD2dBitmap(HIMAGE hImageFrame){return XDraw_GetD2dBitmap(m_hDraw, hImageFrame);}
